...
1. Explain what a token is used for.
  A token is used after one is verified their account and is almost like a badge to allow one into other parts of a site via protected routes
2. What steps can you take in your web apps to keep your data secure?
  dont store data on local storage unless encrypted
3. Describe how web servers work.
  Web Servers are both physical hardware and software that host our application. They use URL and domain name to be accessible by those on the World Wide Web.
